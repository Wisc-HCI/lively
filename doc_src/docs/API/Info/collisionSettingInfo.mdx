...
This is a parameter `collision_settings` that allows the user to customize the collision checking system while configuring a [`Solver`](Solver/initialization)

...
<img src={capsule} alt='capsule' width='200'/>
...
|<span class='attr-length'>`length`</span>|float|The length of <span class='attr-length'>`length`</span> of the capsule, not including caps|
|<span class='attr-radius'>`radius`</span>|float|The length of <span class='attr-radius'>`radius`</span> of the capsule|

...
|---|---|---|
|`name`|string|Name can be arbitrary and should be unqiue|
|`weight`|float|A float value starting from 0 that determines how important an objective is. For example,  |

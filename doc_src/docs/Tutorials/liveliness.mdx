    ...
    useEffect(()=>{
        ...
        */
        ...
        const init = async ()=>{
            ...
            const newSolver = new lively.Solver(
                urdfs.panda, // The urdf of the robot
                {
                    ...
                    'jointLively1':{
                        name: 'MyLivelinessObjective1',
                        type: 'JointLiveliness',
                        weight: 25,
                        joint: 'panda_joint5',
                        frequency: 25
                    },
                    'jointLively2':{
                        name: 'MyLivelinessObjective2',
                        type: 'JointLiveliness',
                        weight: 20,
                        joint: 'panda_joint7',
                        frequency: 25
        ...
        const updateSolver = () => {
            ...
            let goal = { // An goal example with defined Scalar and Size values for the lively objectives
            ...
            const newState = currentSolver.solve(goal,{},Math.sin(time/1000)/4+0.95); // The time parameter for the solve cannot be 0.0. 
            // Update the solver's current state

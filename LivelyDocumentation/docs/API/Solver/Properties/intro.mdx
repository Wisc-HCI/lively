...
## Modifying current [`objectives`](../../Objectives/objective)
Replace the current [`objectives`](../../Objectives/objective) with new [`objectives`](../../Objectives/objective) lookup table
<Tabs>
<TabItem value="js" label="Javascript">
